...
### [3.5.](#section3-5) Extracting the Pixel Values for the Training Data and Assigning Vegetation Classes
### [3.6.](#section3-6)  Visualizing the Vegetation Classes Distribution of Training Data
...
### **3.5. Extracting the Pixel Values for the Training Data and Assigning Vegetation Classes**{#section3-5}
...
```{r preparing the training data, echo = TRUE, include=TRUE}
...
### **3.6. Visualizing the Vegetation Classes Distribution of Training Data**{#section3-6}
...
```{r visualizing the vegetation classes of training data, echo = TRUE, include=TRUE}
