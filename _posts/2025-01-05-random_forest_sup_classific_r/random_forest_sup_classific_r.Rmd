...
In a few words, my goal here is to use a drone image I took and make a **model able to identify what is Bare Soil, Grass, and Trees** on it.
...
### **2.6. Visualizing the Raster and the Polygons**
...
We also want to check the CRS and make sure it is correct.
